...
extern float BetaThickRangeRatio;

extern float BetaMin;
extern float BetaMax;

// Density, below which a point isn't even looked at as far as being
// a beta point.
extern float SeedDensityThreshold;
...
extern float SeedDensityFalloff;

// &&& Better, a binary search probably
extern float LineIncrement;

// In physical coordinates
extern float RequiredNewPointSeparation;
