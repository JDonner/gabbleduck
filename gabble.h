...
//#include "jgdSymmetricTotalEigenAnalysisImageFilter.h"
...
#define WANT_EIGENVECTOR
  ...
  typedef   itk::TotalEigenImageFilter
  < HessianImageType, EigenValueImageType, EigenVectorImageType >
  ...
  // 'casts' (usually different dimensions) first type to second type.
